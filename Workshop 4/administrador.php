    ...
    <table>
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="editar.php?id=<?php echo $mostrar['cedula'];?>">Editar</a>    
                </td>
                <td>
                    <a href="eliminar.php?id=<?php echo $mostrar['cedula']; ?>" onclick="return confirm('¿Estás seguro de que quieres eliminar este usuario?')">Eliminar</a>
                </td>
            </tr>
        <?php
        }
