...
<body class="bg-gray-100 h-screen flex items-center justify-center overflow-hidden relative overflow-y-auto">
    ...
    <div class="bg-white p-8 rounded-md shadow-md max-w-xl w-full relative">
        ...
        <form action="../Controller/user_controller.php" method="post">
            ...
            <p class="text-sm text-gray-600 p-1 mt-2">¿Ya tienes cuenta? <a href="../../index.php" class="text-blue-500">Iniciar Sesión</a></p>
    ...
    <script src="../../public/Js/script_pais.js"></script>
</body>
